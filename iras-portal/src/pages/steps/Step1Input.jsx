...
function getErrors(data) {
  ...
  if (!data.uploadedFile) e.upload = 'A supporting document is required for all adjustment requests.'
  return e
}
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white border border-iras-border rounded px-5 py-3 mb-5 flex items-start gap-3">
        ...
        <div className="text-xs text-gray-600 space-y-1">
          ...
          <p>· A <strong>supporting document is required</strong> for all requests</p>
